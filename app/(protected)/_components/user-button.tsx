  ...
  return (
    <DropdownMenu>
        ...
        <DropdownMenuContent>
            ...
            <DropdownMenuSeparator />
            <DropdownMenuItem onClick={onClick} className='text-destructive dark:text-red-500 w-full cursor-pointer hover:bg-destructive/20 flex items-center justify-center'>
                Log out
            </DropdownMenuItem>
        </DropdownMenuContent>
    </DropdownMenu>
